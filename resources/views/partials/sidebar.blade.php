 <aside id="sidebar" class="w-64 bg-slate-900 text-white flex-shrink-0 flex flex-col"><!-- Logo -->
   ...
   data-page="dashboard"
   class="nav-link sidebar-item flex items-center gap-3 px-4 py-3 rounded-xl w-full text-left
   ...
   <svg class="w-5 h-5" fill="none" stroke="currentColor" viewbox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /> </svg>
    <span class="font-medium">Reports</span>
      ...
      <a href="{{ route('profile.edit') }}" data-page="settings" class="nav-link sidebar-item flex items-center gap-3 px-4 py-3 rounded-xl w-full text-left
    ...
    <div class="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold
                {{ auth()->user()->avatar ? '' : 'bg-gradient-to-br from-violet-400 to-purple-500' }}">
        @if(auth()->user()->avatar)
    ...
    <div class="flex-1 min-w-0">
        <p id="sidebar-user" class="font-medium truncate">
            {{ auth()->user()->name }}
        </p>
    </div>
