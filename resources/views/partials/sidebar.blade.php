 <aside id="sidebar" class="w-64 bg-slate-900 text-white flex-shrink-0 flex flex-col"><!-- Logo -->
    ...
    <nav class=" p-4 space-y-1"><button onclick="showPage('dashboard')" data-page="dashboard" class="nav-link sidebar-item flex items-center gap-3 px-4 py-3 rounded-xl bg-slate-800 text-emerald-400 w-full text-left">
    ...
    <a href="{{ route('invoices.index') }}" data-page="invoices" class="nav-link sidebar-item flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:text-white hover:bg-slate-800 w-full text-left {{ request()->routeIs('invoices.*') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800' }} ">
      ...
      <a href="{{ route('expenses.index') }}" data-page="expenses" class="nav-link sidebar-item flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:text-white hover:bg-slate-800 w-full text-left {{ request()->routeIs('expenses.*') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800' }} ">
      ...
      </svg><span class="font-medium">Expenses</span> </a> 
      <a href="{{ route('time-entries.index') }}" data-page="time-tracking" class="nav-link sidebar-item flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:text-white hover:bg-slate-800 w-full text-left {{ request()->routeIs('time-entries.*') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800' }} ">
      ...
      </svg><span class="font-medium">Time Tracking</span> </a> 
      <a href="{{ route('reports.index') }}" data-page="reports" class="nav-link sidebar-item flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:text-white hover:bg-slate-800 w-full text-left {{ request()->routeIs('reports.*') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800' }} ">
      <svg class="w-5 h-5" fill="none" stroke="currentColor" viewbox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
      </svg><span class="font-medium">Reports</span> </a> 
      <button onclick="showPage('settings')" data-page="settings" class="nav-link sidebar-item flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:text-white hover:bg-slate-800 w-full text-left">
