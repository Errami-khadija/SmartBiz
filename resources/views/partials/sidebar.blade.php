 <aside id="sidebar" class="w-64 bg-slate-900 text-white flex-shrink-0 flex flex-col"><!-- Logo -->
    ...
    <nav class="flex-1 p-4 space-y-1"><button onclick="showPage('dashboard')" data-page="dashboard" class="nav-link sidebar-item flex items-center gap-3 px-4 py-3 rounded-xl bg-slate-800 text-emerald-400 w-full text-left">
      ...
      </svg><span class="font-medium">Dashboard</span> </button> <button onclick="showPage('projects')" data-page="projects" class="nav-link sidebar-item flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:text-white hover:bg-slate-800 w-full text-left">
      ...
      </svg><span class="font-medium">Projects</span> </button> 
    ...
    </a> <button onclick="showPage('invoices')" data-page="invoices" class="nav-link sidebar-item flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:text-white hover:bg-slate-800 w-full text-left">
      ...
      </svg><span class="font-medium">Invoices</span> </button> <button onclick="showPage('expenses')" data-page="expenses" class="nav-link sidebar-item flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:text-white hover:bg-slate-800 w-full text-left">
